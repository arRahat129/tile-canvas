...
const Footer = () => {
    return (
        <footer className="w-full bg-background pt-10 pb-6 my-10 border-t border-divider">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
                    ...
                    <div className="md:col-span-5">
                        <div className="flex flex-col gap-2">
                            <h2 className="text-2xl font-bold tracking-tight">
                                <span className="text-primary">TILE</span>CANVAS
                            </h2>
                    ...
                    <div className="md:col-span-4">
                        ...
                        <ul className="flex flex-col gap-2 text-small text-default-500">
                            <li>Email: <Link size="sm" href="mailto:hello@tilecanvas.com">hello@tilecanvas.com</Link></li>
                            <li>Support: +1 (555) 000-TILE</li>
